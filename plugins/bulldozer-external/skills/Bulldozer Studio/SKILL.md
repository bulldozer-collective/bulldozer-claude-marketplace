...
when-to-use: Use when the user wants to produce visual creative assets via Bulldozer — e.g., requests to generate, create, make, render, or produce images, videos, creatives, visuals, or ads.
